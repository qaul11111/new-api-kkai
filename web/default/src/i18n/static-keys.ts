...
export const STATIC_I18N_KEYS = [
  ...
  // LinkAI public pages (dynamic content labels)
  'Preface - Model compatibility (required)',
  'OpenAI official SDK tutorial',
  'High-concurrency batch request examples',
  'Claude Code API configuration guide',
  'OpenAI Codex API configuration guide',
  'Gemini CLI API configuration guide',
  'OpenClaw API tutorial',
  'OpenCode API tutorial',
  'Trae API tutorial',
  'CC Switch API tutorial',
  'Model compatibility',
  ...
  'Top P',
  'Limits the token selection range by probability mass',
  'Frequency penalty',
