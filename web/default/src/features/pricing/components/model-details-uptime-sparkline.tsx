...
// ---------------------------------------------------------------------------
//
// Compact uptime visualisation over whatever window the supplied series
// covers: a row of small coloured bars where:
...
//   - Hovering a bar reveals the exact timestamp and uptime
//
// Useful as a per-row visual inside the per-group performance table.
  ...
  return (
    <div className={cn('flex items-center gap-2', props.className)}>
      <div
        ...
        role='img'
        aria-label={`${t('Uptime')} ${overall.toFixed(2)}%`}
      >
